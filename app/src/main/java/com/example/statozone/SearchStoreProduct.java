...
public class SearchStoreProduct extends AppCompatActivity {
    private final static String URL = "https://food.tbvcsoft.com/app/storeproductsearch.php";
    private ImageView near, alert, explore, cart, account, cross;
    private EditText etSearch,searchEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();
         StoreId = intent.getStringExtra("SearchStoreId");
        ...
        explore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SearchStoreProduct.this,Explore.class);
        ...
        near.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SearchStoreProduct.this,Homepage.class);
                startActivity(intent);
            }
        });
        alert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SearchStoreProduct.this,Alert.class);
                startActivity(intent);
            }
        });
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SearchStoreProduct.this,CartView.class);
                startActivity(intent);
            }
        });
        account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SearchStoreProduct.this,Account.class);
                startActivity(intent);
            }
        });
        searchEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (SearchKey.length() > 2) {
                    ...
                    if (mProductArrayList.contains(SearchKey)) {
                        adapter1.getFilter().filter(SearchKey);
                        lvProducts.setAdapter(adapter1);
                        lvProducts.setVisibility(View.VISIBLE);
                        SearchNotFound.setVisibility(View.INVISIBLE);
                    }
    ...
    public void SearchProduct(String store_id) {
        ...
        class dbclass extends AsyncTask<String, Void, String> {
            protected void onPostExecute(String data) {
                try {
                    ...
                    adapter1 = new MyAdapter(SearchStoreProduct.this, mProductArrayList);
                } catch (Exception ex) {
                    Toast.makeText(SearchStoreProduct.this, "Please check your mobile internet", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        private class ViewHolder {
            ...
            TextView tvName,DelPrice,UnitPrice,Byname,StrBy;
            ImageView listImage;
        }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.StrBy = (TextView) convertView.findViewById(R.id.StrBy);
            ...
            holder.StrBy.setVisibility(View.INVISIBLE);
            holder.Byname.setVisibility(View.INVISIBLE);
            ...
            Glide.with(SearchStoreProduct.this).load(mDisplayedValues.get(position).image).into(holder.listImage);
            holder.llContainer.setOnClickListener(new View.OnClickListener() {

                public void onClick(View v) {
                    Intent intent = new Intent(SearchStoreProduct.this,ProductView.class);
                    intent.putExtra("product_id", mDisplayedValues.get(position).user_id);
                    intent.putExtra("storeUser_id", mDisplayedValues.get(position).ID);
                    startActivity(intent);
                }
            });
            return convertView;
    ...
    public final boolean isInternetOn() {
        ...
        if ( connec.getNetworkInfo(0).getState() == android.net.NetworkInfo.State.CONNECTED ||
            ...
            Intent intent = new Intent(SearchStoreProduct.this,IntenrNetconnection.class);
            startActivity(intent);
