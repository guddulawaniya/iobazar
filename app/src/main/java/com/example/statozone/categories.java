...
{
    private  static final String url="https://zone.tbvcsoft.com/app/category.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(categories.this,CartView.class);
                startActivity(intent);
            }
        });
        ...
        StringRequest request=new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                LinearLayoutManager horizontalLayoutManagaer
                        = new GridLayoutManager(categories.this,2, LinearLayoutManager.VERTICAL, false);
                shimmerFrameLayout.startShimmer();
    ...
    public class myadapter extends RecyclerView.Adapter<myadapter.myviewholder>
    {
        ...
        public  myadapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.categoriesrow,parent,false);
    ...
    private void AddtoCart(Integer number, String pr_id, int user_id, Integer Total_amount)
    {
        ...
        class dbManager extends AsyncTask<String, Void, String>
        {
            ...
            {
                try {Toast.makeText(categories.this,data,Toast.LENGTH_LONG).show();
                }
                catch (Exception ex)
                {
